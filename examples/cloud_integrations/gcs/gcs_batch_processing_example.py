...
class BatchProcessor:
    ...
    def process_file_with_analytics(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"  ✅ {quality_report.record_count} records, {quality_report.column_count} columns")
    ...
    def _print_analytics_summary(self, metrics: ProcessingMetrics, results: List[Dict]):
        ...
        print(f"   • Success Rate: {(metrics.successful_files/metrics.total_files)*100:.1f}%")
